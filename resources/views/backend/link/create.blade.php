            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="link_create"   action="{{route('admin.link.store')}}" data-parsley-validate  class="form-horizontal form-label-left" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="url" name="url" required="required" class="form-control col-md-7 col-xs-12" data-parsley-type="url">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-inline">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                ...
                                                <input type="text"  name="thumb"  class="form-control col-md-6" />
                                                <a class="btn btn-small btn-success" onclick="javascript:uploadmyFile();">选择图片</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3">
                                        <img id="thumb" src="" style="max-width:200px;max-height: 100px; "/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea  name="introduce" class="resizable_textarea form-control" placeholder="站点简介"></textarea>
                                        </div>
                                    </div>
